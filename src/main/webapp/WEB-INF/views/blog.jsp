...
<!--                         <li class="active"><a href="blog.html">Events</a></li> -->
...
<!--     <section class="site-hero inner-page overlay" style="background-image: url(img/slider-7.jpg)" data-stellar-background-ratio="0.5"> -->
<!--       <div class="container"> -->
...
<!--                           <h3>Unwind with Your Family in our Luxury Services</h3> -->
<!--                         </div> -->
<!--                       </a> -->
<!--                     </li>   -->
<!--                     <li> -->
